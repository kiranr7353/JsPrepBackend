...
exports.addProgrammingQA = async (req, res) => {
    try {
...
exports.updateProgrammingQA = async (req, res) => {
    try {
...
exports.deleteProgrammingQA = async (req, res) => {
    try {
...
exports.bookmarkProgrammingQA = async (req, res) => {
    try {
        const { titleId } = req.body;
        const user = req?.user;
        let errorObj = handleValidations(res, [ {'titleId': titleId} ]);
...
exports.removebookmarkedProgrammingQA = async (req, res) => {
    try {
        const { titleId } = req.body;
        const user = req?.user;
        let errorObj = handleValidations(res, [ {'titleId': titleId} ]);
